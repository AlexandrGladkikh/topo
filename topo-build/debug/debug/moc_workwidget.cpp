...
struct qt_meta_stringdata_WorkWidget_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WorkWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WorkWidget_t qt_meta_stringdata_WorkWidget = {
    {
QT_MOC_LITERAL(0, 0, 10) // "WorkWidget"
...
const QMetaObject WorkWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WorkWidget.data,
      qt_meta_data_WorkWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WorkWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WorkWidget.stringdata))
